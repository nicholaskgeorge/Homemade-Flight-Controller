...
/////////////////PID CONSTANTS/////////////////
double kpx=0.007;//7
double kix=0.006;//0.003
double kdx=0.4;//2.05
double kpy=0.007;//0.007
double kiy=0.006;//0.002
double kdy=0.4;//0.4
///////////////////////////////////////////////
...
/////////////////////////////I M U/////////////////////////////////////
 ...
 // Serial.println("x angle is: " + String(Total_angle[0]) + " y is: " + String(Total_angle[1]+2));
  //PID Control
  
  errory = (Total_angle[1]+2) - desired_angley;//before correction was originally just 1
  ...
  Serial.println('Y axis p is: '+ String(pid_py)+' the d is: '+ String(pid_dy));
  ...
  m1.writeMicroseconds(m1s);//+10 was here
  m2.writeMicroseconds(m2s);
  m3.writeMicroseconds(m3s);//+10 was here
